...
export const EventAdd = ({ refreshAction }: Props) => {
    ...
    const eventSchema = z.object({
        ...
        descriptionField: z.string().min(1, 'Prencha a Descrição'),
        ...
        <div>
            <div className="mb-5">
                ...
                <InputField
                    ...
                    errorMesasge={errors.find(item => item.field === 'titleField')?.message}
                />
            </div>
            <div className="mb-5">
                ...
                <InputField
                    ...
                    errorMesasge={errors.find(item => item.field === 'descriptionField')?.message}
                    disabled={loading}
                />
            </div>
            <div className="mb-5">
