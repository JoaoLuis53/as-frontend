...
export const EventItem = ({ item, refreshAction, openModal }: Props) => {
    ...
    return (
        <div className="border bordr-gray-700 rounded p-3 mb-3 flex flex-col items-center md:flex-row">
...
export const EventItemNotFound = () => {
    return (
        <div className="bg-gray-800  py-3 text-gray-500 uppercase flex items-center justify-center
         w-full h-16 border border-gray-700 rounded mb-3 ">Não há Eventos Cadastrados!!</div>
    );
}