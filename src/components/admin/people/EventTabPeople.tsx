...
export const EventTabPeople = ({ eventId, item, refreshAction }: Props) => {
    //Group
    ...
    return (
        <div>
            <div className='my-3'>
                {!groupLoading && groups.length > 0 &&
                    <select
                        ...
                        className='w-full bg-gray-800 border border-gray-600 rounded text-white text-xl p-4 outline-none'
                    >
            ...
            {selectedGroupId > 0 &&
                <>
                    <div className='border border-dashed p-3 my-3 rounded' >
                        {!selectedPerson &&
                            <PersonAdd
                                eventId={eventId}
